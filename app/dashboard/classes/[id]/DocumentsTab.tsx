...
export function DocumentsTab({ classId, title }: { userId?: string, classId?: string, title: string }) {
  ...
  async function handleUpload(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    const res = await fetch(`/api/classes/${classId}/documents`, { method: "POST", body: fd })
