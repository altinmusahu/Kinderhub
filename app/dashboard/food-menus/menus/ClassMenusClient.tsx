...
export default function ClassMenusClient({ readOnly = false }: { readOnly?: boolean }) {
      ...
      {!cells ? (
        ...
        <div className="kh-card kh-print-area" style={{ overflow: "hidden" }}>
                        ...
                        <td key={date} style={{ padding: "6px 8px", verticalAlign: "top", minWidth: 150 }}>
                          {isEditing ? (
                            ...
                            <div
                              ...
                              style={{
                                padding: "6px 8px", borderRadius: 8, fontSize: 12.5, cursor: readOnly ? "default" : "pointer", minHeight: 36,
                                color: cell.description ? "var(--kh-ink-800)" : "var(--kh-ink-300)",
                                display: "flex", alignItems: "center", gap: 6,
                              }}
                            >
                              {saving === key && <Spinner size="sm" />}
                              {cell.description || (readOnly ? "—" : "Add dish…")}
                            </div>
                          )}
                        </td>
                      )
          ...
          <div className="no-print" style={{ padding: "10px 18px", borderTop: "1px solid var(--kh-ink-100)", fontSize: 11.5, color: "var(--kh-ink-400)" }}>
            {readOnly ? "Menus are drafted for this week." : "Menus are drafted for this week — click any cell to edit."}
