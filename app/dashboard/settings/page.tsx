...
export default async function SettingsPage() {
  ...
  const settingsNav = [
    { section: "Organization", items: ["General", "Branding", "Locations"] },
    { section: "People",       items: ["Team & access", "Departments", "Roles & permissions", "Invitations"] },
    { section: "Policies",     items: ["Parent portal", "Notifications", "Data & privacy", "Integrations", "Billing plan"] },
  ]
    ...
    <div className="kh-page" style={{ overflow: "hidden" }}>
      <header className="kh-topbar">
        <nav className="kh-breadcrumb">
          ...
          <span className="kh-breadcrumb-parent">Settings</span>
          <span className="kh-breadcrumb-sep">/</span>
          <span className="kh-breadcrumb-current">Team &amp; access</span>
        </nav>
