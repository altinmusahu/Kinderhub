          ...
          <table className="kh-table">
            ...
            <tbody>
              {families.map((f) => {
                ...
                return (
                  <tr key={f.id} className={f.checked ? "kh-table-row--selected" : ""}>
                    <td>
                      <input type="checkbox" className="kh-checkbox" defaultChecked={f.checked} />
                    </td>
                    <td>
                    ...
                    <td style={{ fontSize: 13, color: "var(--kh-ink-600)" }}>{f.plan}</td>
                    <td style={{ fontSize: 13, color: "var(--kh-ink-700)", fontFamily: "var(--kh-font-mono)" }}>{f.kids}</td>
                    <td style={{ fontSize: 13, color: "var(--kh-ink-500)" }}>{f.room}</td>
                    <td style={{ textAlign: "right", fontFamily: "var(--kh-font-mono)", fontSize: 13, color: f.balanceRed ? "#C0392B" : "var(--kh-ink-700)", fontWeight: f.balanceRed ? 600 : 400 }}>{f.balance}</td>
                    <td style={{ fontSize: 12, color: "var(--kh-ink-400)", fontFamily: "var(--kh-font-mono)" }}>{f.since}</td>
                  </tr>
                )
              })}
            </tbody>
