      ...
      <div className="kh-content">
        ...
        <div className="kh-card" style={{ overflow: "hidden" }}>
          <div className="kh-card-header">
            <span className="kh-card-title">All staff</span>
            <span className="kh-card-meta">18 members</span>
          </div>
                ...
                <tr key={s.id}>
                  <td>
                    <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                      <span className="kh-avatar" style={{ background: s.color + "22", color: s.color }}>
                        {s.id}
                      </span>
                      <span style={{ fontWeight: 600, fontSize: 13, color: "var(--kh-ink-900)" }}>{s.name}</span>
                    </div>
                  </td>
                  <td style={{ fontSize: 13, color: "var(--kh-ink-600)" }}>{s.role}</td>
                  <td style={{ fontSize: 13, color: "var(--kh-ink-500)" }}>{s.dept}</td>
                  <td style={{ fontSize: 13, color: "var(--kh-ink-500)" }}>{s.room}</td>
                  <td>
                  ...
                  <td style={{ fontSize: 12, color: "var(--kh-ink-400)", fontFamily: "var(--kh-font-mono)" }}>{s.shift}</td>
                </tr>
              ))}
            </tbody>
          </table>
